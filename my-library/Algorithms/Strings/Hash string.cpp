...
Hash operator+(Hash a, Hash b) {
  return {sum(a.h1, b.h1, MOD1), sum(a.h2, b.h2, MOD2)};
}
Hash operator-(Hash a, Hash b) {
  return {dif(a.h1, b.h1, MOD1), dif(a.h2, b.h2, MOD2)};
}
Hash operator*(Hash a, Hash b) {
  return {mul(a.h1, b.h1, MOD1), mul(a.h2, b.h2, MOD2)};
}
Hash operator*(Hash h, int x) {
  return {mul(h.h1, x, MOD1), mul(h.h2, x, MOD2)};
}
...
Hash get_substr_hash(int i, int j) { return pref[j] - pref[i] * p[j - i]; }
