...
// http://acm.math.spbu.ru/~sk1/mm/lections/mipt2016-sqrt/solutions/E.OK.kthstat_sk.cpp.html
...
struct Block {
  ...
  int operator[](int ind) { return b[(reversed ? k - 1 - ind : ind)] + delta; }
